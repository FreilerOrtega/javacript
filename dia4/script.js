...
while (bool === true) {
    ...
    menu()
    var opciones = prompt("Porfavor elige una ópcion")
    if (opciones == 1) {
        ...
        let entrada = prompt("escribe")


        for (i = 0; i < json[0]["experiencia_laboral"].length; i++) {
            console.log(i + 1)
            console.log(json[0]["experiencia_laboral"][i]["puesto"]);

            if (entrada == i) {
                json[0]["experiencia_laboral"].splice(i - 1, 1)
            }
        }
        console.log(json)
    }
